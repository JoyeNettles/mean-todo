...
exports.createTodo = async function(req, res, next){
    ...
    try{
        ...
        console.log('next')
        console.log(next)    
        var createdTodo = await TodoService.createTodo(request)
        return res.status(201).json({status: 201, data: createdTodo, message: `Succesfully Created your todo: ${req}`})
    }catch(e){
...
exports.updateTodo = async function(req, res, next){
    ...
    try{
        var updatedTodo = await TodoService.updateTodo(request)
